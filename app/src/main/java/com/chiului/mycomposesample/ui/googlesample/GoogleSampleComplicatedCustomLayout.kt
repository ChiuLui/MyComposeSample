...
import androidx.compose.ui.unit.dp
import com.chiului.mycomposesample.data.SampleData.topics
...
@Composable
fun GoogleSampleComplicatedCustomLayout() {
...
@Composable
fun GoogleSampleComplicatedCustomLayoutPreview() {
    GoogleSampleComplicatedCustomLayout()
}